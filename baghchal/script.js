...
class BaghChal {
    constructor() {
        ...
        this.tigerSound = new Audio('tiger.mp3');
    ...
    initializeBoard() {
        ...
        this.points[0].piece = PieceType.TIGER;
        this.points[4].piece = PieceType.TIGER;
        this.points[20].piece = PieceType.TIGER;
        this.points[24].piece = PieceType.TIGER;
